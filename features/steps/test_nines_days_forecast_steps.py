...
def user_start_the_app_the_first_time(context):
    try:
        context.app.disclaimer.verify_page_loaded()
...
def clicks_agree_button_on_the_disclaimer_page(context):
    try:
        context.app.disclaimer.click_agree_btn()
...
def in_privacy_policy_statements_page(context):
    try:
        context.app.privacy_policy_statements.verify_page_loaded()
...
def clicks_agree_button_on_the_statements_page(context):
    try:
        context.app.privacy_policy_statements.click_agree_btn()
...
def in_background_access_to_location_information_page(context):
    try:
        context.app.device_notification_setting.verify_page_loaded()
...
def clicks_ok_button(context):
    try:
        context.app.device_notification_setting.click_allow_option()
...
def in_background_access_to_location_information_page(context):
    try:
        context.app.background_location_access.verify_page_loaded()
...
def clicks_ok_button(context):
    try:
        context.app.background_location_access.click_OK_btn()
...
def in_new_location_access_page(context):
    try:
        context.app.device_location_access.verify_page_loaded()
...
def clicks_while_using_the_app(context):
    try:
        context.app.device_location_access.click_while_using_the_app_option()
...
def in_location_permission(context):
    try:
        context.app.location_permission_config.verify_page_loaded()
...
def clicks_allow_only_while_using_the_app(context):
    try:
        context.app.location_permission_config.click_allow_all_the_time_option()
...
def clicks_back_button_in_location_permission(context):
    try:
        context.app.location_permission_config.press_device_back_btn()
        time.sleep(5)
    except NoSuchElementException as e:
        print("Failed", e)
...
def in_whats_new_page1(context):
    try:
        context.app.whats_new.verify_sub_page1_loaded()
...
def clicks_next_in_whats_new_page1(context):
    try:
        context.app.whats_new.click_next_btn()
...
def in_whats_new_page2(context):
    try:
        context.app.whats_new.verify_sub_page2_loaded()
...
def clicks_next_in_whats_new_page2(context):
    try:
        context.app.whats_new.click_not_show_btn()
...
def in_home_page(context):
    try:
        # context.app.home.go()
        context.app.home.verify_page_loaded()
...
def clicks_menu_bar(context):
    try:
        context.app.home.open_header_ham_menu_btn()
...
def in_home_page(context):
    try:
        # context.app.home.go()
        context.app.home_header_ham_menu.verify_page_loaded()
...
def scroll_down_menu_bar_and_click_nine_days_forecast(context):
    try:
        context.app.home_header_ham_menu.open_forecast_warning_service_dropdownlist()
        context.app.home_header_ham_menu.select_nine_days_forecast()
...
def in_nine_days_forecast(context):
    try:
        context.app.nine_days_forecast.verify_page_loaded()
